...
pub fn (h VesperHandler) handle(req http.Request) http.Response {
	mut app := h.app
...
fn swagger_ui_html(openapi_path string) string {
	return '<!DOCTYPE html><html><head><title>Vesper API Docs</title></head><body>
<h1>Vesper API</h1>
